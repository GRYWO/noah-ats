  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-3 left-1/2 -translate-x-1/2 z-20 inline-flex items-center gap-3 px-6 py-2 min-w-[280px] sm:min-w-[360px] bg-white border border-gray-200 hover:border-gray-300 rounded-full shadow-sm text-sm text-gray-500 hover:text-gray-700 transition-colors"
      >
        <Search size={15} />
        <span className="hidden sm:inline flex-1 text-left">Snel zoeken...</span>
