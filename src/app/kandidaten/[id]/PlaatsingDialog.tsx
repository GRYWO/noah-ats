    ...
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full my-8">
        ...
        <form action={meldPlaatsing} className="p-6 space-y-5">
          ...
          {/* Werving & Selectie: bedrag */}
          {basis === "werving_selectie" && (
            <div>
              <label className="block text-xs font-semibold text-gray-600 mb-1">Fee-bedrag (€) *</label>
              ...
              <small className="text-gray-400 text-xs">Werkelijk fee-bedrag dat aan klant gefactureerd wordt.</small>
            </div>
          )}
