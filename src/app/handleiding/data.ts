  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    secties: [
      ...
      },
      {
        kop: "Super-admin",
        tekst: [
          "Yorith Hulzebosch (yorith@noah-recruitment.nl). Alleen op basis van e-mail, hardcoded in src/utils/auth.ts.",
    ...
    secties: [
      {
        ...
        lijst: [
          ...
          "Resend, transactionele mail vanaf noah-recruitment.nl (geverifieerd domein)",
