              ...
              <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
                ...
                <form action={onSubmit} className="p-5 grid grid-cols-2 gap-4 overflow-y-auto">
                  ...
                  <div className="col-span-2">
                    ...
                    <input name="mail_adres" type="email" defaultValue={s.mail_adres ?? ""} placeholder="voornaam.achternaam@noah-recruitment.nl" className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm" />
                    <small className="text-gray-400 text-xs">
                      Vul het exacte @noah-recruitment.nl-mailadres in van de Hostnet-mailbox. Voorstellen-mails worden hier vanaf verzonden. Leeg = automatisch <code className="bg-gray-100 px-1 rounded">{`voornaam@noah-recruitment.nl`}</code>.
                    </small>
                  </div>
                  <div className="col-span-2">
