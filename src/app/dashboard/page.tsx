    ...
    <main className="min-h-screen bg-[#f4f4f7]">
      <div className="bg-[#333399] h-16 flex items-center px-6 shadow-md">
        ...
        <nav className="ml-8 flex gap-1">
          <Link href="/dashboard" className="text-white bg-white/15 px-3 py-1.5 text-sm rounded-md">Dashboard</Link>
          {isSuperAdmin && (
            <Link href="/bureaus" className="text-white/70 hover:text-white px-3 py-1.5 text-sm rounded-md hover:bg-white/10">Bureaus</Link>
          )}
          ...
          <Link href="/inbox" className="text-white/70 hover:text-white px-3 py-1.5 text-sm rounded-md hover:bg-white/10">E-mail</Link>
          {!isSetter && (
